...
export const infos: InfoLdg[] = [
  {
    title: "Features",
    description:
      "For SaaS startups scaling their customer base, Teams with limited resources looking to do more with less and Founders who value long-term growth over churn.",
    image: "/_static/illustrations/work-from-home.jpg",
    list: [
      {
        title: "Churn Prediction",
        description: "Know who’s at risk and how to keep them.",
        icon: "arrowUpRight",
      },
      {
        title: "Automated Engagement",
        description: "Save time while maintaining a personal touch.",
        icon: "arrowUpRight",
      },
      {
        title: "Actionable Insights",
        description:
          "Let AI turn data into strategies that work.",
        icon: "arrowUpRight",
      },
    ],
  },
